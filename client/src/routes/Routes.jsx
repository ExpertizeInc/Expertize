...
const Routes = ({ authenticated, user, history, linkedInSignIn, signOut, fbSignIn, client, addFirebaseUser }) => (
    <div className="content">
      ...
      <Switch>
          ...
          <Route exact strict path="/signup" render={(props) => <Signup {...props} addFirebaseUser={addFirebaseUser} client={client} linkedInSignIn={linkedInSignIn} fbSignIn={fbSignIn}/>}></Route>
