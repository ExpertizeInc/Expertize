        ...
        <Row>
          <Col xsOffset={4} xs={6} md={4}>
            <Form className="form-panel-signup centered" horizontal>
              ...
              <FormGroup>
                <Col className="centered">
                  <h5 className="centered">This will cost: {user.debt > 0 ? 2 + user.debt : 2} <Image style={{ width: "20px" }} src="../../dist/images/coin.gif"></Image></h5>
                  <h5>You have: {user.coins}<Image style={{ width: "20px" }} src="../../dist/images/coin.gif"></Image></h5>
                  <Mutation
