...
const Routes = ({ authenticated, user, signIn, signInLI, linkedInEmail, linkedInId, LIResults, signOut }) => (
    <div>
      ...
      <Switch>
          ...
          <Route path='/test' component={() => window.location = 'https://www.linkedin.com/oauth/v2/authorization?response_type=code&client_id=77jrp4h9m6f6yf&redirect_uri=http%3A%2F%2Flocalhost%3A3001&state=321'}/>
