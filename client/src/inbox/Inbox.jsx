        ...
        <Row className="clearfix">
          <Col xs={6} md={3}>
            <Nav bsStyle="pills" stacked>
              <NavItem className="link-alt" eventKey="first">
                Received
              </NavItem>
              <NavItem className="link-alt" eventKey="second">
                Sent
              </NavItem>
              <NavItem className="link-alt" eventKey="third">
                Compose
              </NavItem>
            </Nav>
          </Col>
                ...
                <Col sm={9}>
                  <Tab.Content animation>
                    ...
                    <Tab.Pane eventKey="second">
                      <SentMessages messages={data.messagesSent} />
                    </Tab.Pane>
